...
namespace EonTimer::timer {
    ...
    const std::shared_ptr<std::vector<int>> EnhancedEntralinkTimer::createStages(const int targetDelay,
    ...
    int EnhancedEntralinkTimer::createStage2(const int targetDelay,
                                             const int calibration,
