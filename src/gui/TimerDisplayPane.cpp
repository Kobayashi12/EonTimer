...
namespace gui {
    TimerDisplayPane::TimerDisplayPane(service::ChronoEngine *timerService,
        ...
        connect(timerService, &service::ChronoEngine::stateChanged, [this](const model::TimerState &state) {
        ...
        connect(timerService,
                &service::ChronoEngine::minutesBeforeTargetChanged,
        ...
        connect(
            timerService,
            &service::ChronoEngine::nextStageChanged,
            [this](const std::chrono::milliseconds &nextStage) { this->nextStage->setText(formatTime(nextStage)); });
        connect(timerService, &service::ChronoEngine::actionTriggered, this, &TimerDisplayPane::activate);
